...
import org.gfg.NotificationService.utils.Constants;
...
//        mailSender.send(simpleMailMessage);
        ...
        mailMessage.setSubject("Notification Sent");
        mailMessage.setText("Welcome "+ name+ " to Ewallet. User has been Created, wallet will created in while.");
